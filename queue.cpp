...
void QueueVisualizer::visualize() {
	ListNode* clone = head;
	while (clone) {
		clone->displayNode();
		clone = clone->next;
...
void QueueVisualizer::initialize(vector<string> list) {
	freeMem();
...
void QueueVisualizer::reCalcCoordinate() {
	ListNode* clone = head;
	if (!clone) return;
	clone->centerX = 100;
	clone->centerY = 100;
...
void QueueVisualizer::resetColor() {
	ListNode* clone = head;
	while (clone) {
...
void QueueVisualizer::resetArrow() {
	ListNode* clone = head;
	while (clone) {
...
ListNode* QueueVisualizer::getNode(int idx) {
	ListNode* clone = head;
	while (idx--) {
		clone = clone->next;
	}
...
void QueueVisualizer::popStep(bool checkStep) {
...
void QueueVisualizer::pushStep(string val, bool checkStep) {
	SDL_Texture* buttonSpriteSheet = loadImgTexture("resources/Button/ButtonSpriteSheet.png");
	SDL_Texture* explain = loadImgTexture("resources/Prompt/Explanation.png");
	TTF_Font* generalFont = TTF_OpenFont("resources/Font/SpaceMono-Regular.ttf", 100);
	int linesColor = -1;
...
void QueueVisualizer::insertEmpty(string val, bool checkStep) {
	SDL_Texture* buttonSpriteSheet = loadImgTexture("resources/Button/ButtonSpriteSheet.png");
	SDL_Texture* explain = loadImgTexture("resources/Prompt/Explanation.png");
...
void QueueVisualizer::clearStep(bool checkStep) {
	SDL_Texture* buttonSpriteSheet = loadImgTexture("resources/Button/ButtonSpriteSheet.png");
	SDL_Texture* explain = loadImgTexture("resources/Prompt/Explanation.png");
	TTF_Font* generalFont = TTF_OpenFont("resources/Font/SpaceMono-Regular.ttf", 92);
	int linesColor = -1;
